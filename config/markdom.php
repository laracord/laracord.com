...
return [
    ...
    'classes' => [
        ...
        'blockquote' => '[quotes:none] [&_strong]:!text-blue-500 text-white/80 not-italic border-l-blue-500 bg-black/25 py-3 rounded text-sm [&_p]:m-0 [&>p_code]:!text-blue-500 [&_h4]:text-blue-500 [&_h4]:m-0 [&_h4]:mb-2 [&_h4_a]:hidden',
    ],
